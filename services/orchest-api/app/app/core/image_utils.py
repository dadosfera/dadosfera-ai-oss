        ...
        if _config.CONTAINER_RUNTIME == 'containerd':
            env = [
                {"name":"AWS_ACCESS_KEY_ID", "valueFrom": {
                        "secretKeyRef":{"name":"aws-customer-iam-role", "key":"AWS_ACCESS_KEY_ID"}}
                },
                {"name":"AWS_SECRET_ACCESS_KEY", "valueFrom": {
                        "secretKeyRef":{"name":"aws-customer-iam-role", "key":"AWS_SECRET_ACCESS_KEY"}}
                },
                {"name":"AWS_SESSION_TOKEN", "valueFrom": {
                        "secretKeyRef":{"name":"aws-customer-iam-role", "key":"AWS_SESSION_TOKEN"}}
                }
            ]
                    ...
                    "volumeMounts": [
                        {
                            ...
                            "subPath": _utils.get_userdir_relpath(build_context_host_path),
                            "readOnly": True,
                        },
                    ]
